    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <div class="nav-links">
                ...
                <li class="active">  <a href="<?php echo base_url('Contact'); ?>"> <b style="color: red;"> Contact </b></a></li>
            </div>
        ...
        <div class="top-info">
            ...
            <span>
                <a href="https://wa.me/919861357334" target="_blank"><i class='fab fa-whatsapp'></i></a>
            </span>
            <span>
